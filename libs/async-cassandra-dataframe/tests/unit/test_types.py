...
class TestCassandraTypeMapper:
    ...
    def test_basic_type_mapping(self, mapper):
        ...
        # String types
        assert mapper.get_pandas_dtype("text") == "object"
        assert mapper.get_pandas_dtype("varchar") == "object"
        assert mapper.get_pandas_dtype("ascii") == "object"
        ...
        assert mapper.get_pandas_dtype("decimal") == "object"  # Preserve precision
        assert mapper.get_pandas_dtype("varint") == "object"  # Unlimited precision

        # Temporal types
        assert mapper.get_pandas_dtype("timestamp") == "datetime64[ns, UTC]"
        assert mapper.get_pandas_dtype("date") == "datetime64[ns]"
        assert mapper.get_pandas_dtype("time") == "timedelta64[ns]"

        # Other types
        assert mapper.get_pandas_dtype("boolean") == "bool"
        assert mapper.get_pandas_dtype("uuid") == "object"
